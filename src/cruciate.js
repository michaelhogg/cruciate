(function() {
    ...
    themes.dark.properties = {
        ...
        pageHeader: {
            ...
            dProgressBar:        themes.dark.images.progressBarBackgroundImage
        },
        ...
        diffNav: {
            ...
            dDownArrow: themes.dark.images.downArrow
        },
